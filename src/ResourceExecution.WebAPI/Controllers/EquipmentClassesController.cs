...
[Route("/api/resources/equipment-classes")]
public class EquipmentClassesController : BaseController
{
    ...
    public async Task<IActionResult> AddCapability([FromRoute] Guid id, [FromBody] EquipmentClassCapabilityCreateRequestDTO request, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    [HttpPatch("{id:guid}/capabilities")]
